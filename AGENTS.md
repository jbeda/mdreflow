...
Docs and comments describe **current state only** — no history, no "used to", no references to the change that introduced a thing.
History lives in git and CHANGELOG.md; everywhere else it is confusion.
